...
import Msc from './elements/msc.js';//TODO cf. #386 remove after texml#146 rolls out
import MscKey from './elements/mscKey.js';//TODO cf. #386 remove after texml#146 rolls out
...
export class Transformer {
     ...
     */
    constructor(htmldoc, imageAltDictionary) {
        // the HTML document
        ...
        // fig-like elements
        ['fig-group', 'verse-group', 'table-wrap'].forEach(
    ...
    msc = Msc.bind(this) //TODO cf. #386 remove after texml#146 rolls out
    primary = MscKey.bind(this) //TODO cf. #386 remove after texml#146 rolls out
    ...
    secondary = this['primary'] //TODO cf. #386 remove after texml#146 rolls out
    ...
    'alg:body' = this.passThrough; // TODO no test (case)
    'alg:outputs' = this.passThrough; // TODO no test (case)
    'alg:inputs' = this.passThrough; // TODO no test (case)
    'alg:condition' = this.passThrough;
    'alg:if' = this.passThrough;
    'alg:elsif' = this.passThrough; // TODO no test (case)
    'alg:else' = this.passThrough;
    'alg:for' = this.passThrough;
    'alg:forall' = this.passThrough; // TODO no test (case)
    'alg:while' = this.passThrough; // TODO no test (case)
    'alg:repeat' = this.passThrough; // TODO no test (case)
    'alg:until' = this.passThrough; // TODO no test (case)
    'alg:loop' = this.passThrough; // TODO no test (case)

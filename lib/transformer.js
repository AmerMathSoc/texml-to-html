...
export class Transformer {
    ...
    'alg:body' = this.passThrough;
    'alg:outputs' = this.passThrough;
    'alg:inputs' = this.passThrough;
    'alg:condition' = this.passThrough;
    'alg:if' = this.passThrough;
    'alg:elsif' = this.passThrough;
    'alg:else' = this.passThrough;
    'alg:for' = this.passThrough;
    'alg:forall' = this.passThrough;
    'alg:while' = this.passThrough;
    'alg:repeat' = this.passThrough;
    'alg:until' = this.passThrough;
    'alg:loop' = this.passThrough;
}

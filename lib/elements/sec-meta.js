...
export default function (htmlParentNode, xmlnode) {
  ...
  const secmetaSection = this.createNode('div', '', {
    'data-ams-doc': 'sec-meta',
  });
  if (Object.keys(contributors).length > 0) {
    secmetaSection.setAttribute('data-ams-contributors', JSON.stringify(contributors));
    secmetaSection.setAttribute('data-ams-byline', generateByline(contributors));
  }

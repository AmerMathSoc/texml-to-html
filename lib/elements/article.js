...
export default function (htmlParentNode, xmlnode) {
  ...
  // NOTE journal information seems to get removed in ams-html. Drop it here and update ams-html. See #254
  ...
  // heading (again) NOTE ams-html replaces this heading with the titlepage; after release, drop this heading and update ams-html. See #254
  this.recurseTheDom(
    artSection,

export default function (htmlParentNode, xmlnode) {
  ...
  // NOTE should only occur in implicit text mode (\tag{} etc) or within <text> elements (which are not JATS/BITS and thus occur nowhere else)
  if (xmlnode.parentNode.tagName === 'tex-math' || xmlnode.parentNode.closest('text')) {

...
export default function (htmlParentNode, xmlnode) {
  ...
  // NOTE (long term) One DL per contrib seems odd. Should contrib-group create a single DL around the contrib's DT+DDs? See #254
  ...
  dl.appendChild(dt);
  // NOTE could be a name etc method. See #254

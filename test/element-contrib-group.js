...
tape('Template: contrib-group', async function(t) {
  ...
  t.equal(contribgroup.previousElementSibling.innerHTML, 'ContribA Information', 'contrib-group creates dt with content derived from @content-type'); // NOTE last char stripped

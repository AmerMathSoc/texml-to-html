...
tape('Template: book-meta/publisher, publisher-name, publisher-loc', async function(t) {
  ...
  const input = path.resolve(__dirname, 'element-book-meta-publisher.xml');
  ...
  t.equal(publisher1.firstElementChild.nextElementSibling.outerHTML.trim(), '<span>loc</span>');

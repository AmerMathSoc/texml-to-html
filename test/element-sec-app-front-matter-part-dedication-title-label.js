...
tape('sec, app, front-matter-part, dedication, title, label', async function(t) {
  ...
  t.ok(document.querySelector('#sectitle header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');
  t.ok(document.querySelector('#seclabel header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');
  t.ok(document.querySelector('#fmtitle header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');
  t.ok(document.querySelector('#fmlabel header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');
  t.ok(document.querySelector('#apptitle header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');
  t.ok(document.querySelector('#applabel header p[data-ams-doc="subtitle"][data-ams-doc-level="2"]'), 'sec with title: subtitle to p with data-ams-doc and data-ams-doc-level');


  const input2 = path.resolve(__dirname, 'element-sec-app-front-matter-part-dedication-title-label--book.xml');
  ...
  t.equal(document2.querySelector('#seclabeltitle header h1').innerHTML, 'Label. Title', 'sec with label+title: heading level and content');
  t.equal(document2.querySelector('#sectitle header h1').innerHTML, 'Title', 'sec with title: heading level and content');
  t.equal(document2.querySelector('#seclabel header h1').innerHTML, 'Label', 'sec with label: heading level and content');
  ...
  t.ok(document.querySelector('#appsecmeta section[data-ams-doc="sec-meta"] dl'), 'article sec-meta');
  t.ok(document2.querySelector('#appsecmeta section[data-ams-doc="sec-meta"] p span[data-ams-doc="stringname"]'), 'book sec-meta');
  t.ok(document2.querySelector('#appsecmeta section[data-ams-doc="sec-meta"] section[role="doc-abstract"]'), 'book sec-meta');
});
